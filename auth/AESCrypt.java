...
//        plaintext = String.format("%s_%d", plaintext, new Date().getTime());
    ...
    public static int getResponseCode(String key, String urlRaw, HashMap<String, String> headers) throws Exception{
    ...
    public static void setHeaders(HttpURLConnection con, String key, HashMap<String, String> headers) throws JSONException {
    ...
    public static int send(String key, String urlRaw, HashMap<String, String> headers, List<NameValuePair> params) throws Exception{
        URL url = new URL(urlRaw);
        HttpURLConnection con = (HttpURLConnection) url.openConnection();
    ...
    public static void main(String[] args) throws Exception {
        String key = "moso_doc_ai_auth";

        //test authentication
//        String url = "http://localhost:5001/authenticate";
//        HashMap<String, String> headers = new HashMap<>();
//        headers.put("first_header_name", "asdnalksdnaasdnalksdnaasd2");
//        headers.put("second_header_name", "34234ewrtw352345");
//
//        int status = getResponseCode(key, url, headers);
